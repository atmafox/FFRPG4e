\begin{multicols}{2}
    ...
    \textit{Wicked Waltz} is a level 2 dance. Perform a Water vs Water attack, difficulty 50. If successful, the target loses a third of its current HP\@. This is a \tstatus{Gravity} status effect.
    ...
    \textit{Virulent Flourish} is a level 4 dance. Perform a Water vs Earth attack, difficulty 70. If successful, deal weapon physical damage and inflict the \tstatus{Virus} status on a target until the end of next round.
    ...
    Songs are always Ranged Slow (2) magical actions. They are focused on your allies, increasing their fighting skills and turning you into a powerful support to your teammates.
    ...
    \textit{Element Carol} is a level 3 song. Choose an ally and an element other than: \telem{Cut}, \telem{Crush} or \telem{Puncture}. Grant the \tstatus{Resist} (chosen element) status to that ally until the end of the round. Moreover, while it is under this effect, its weapon gains the Elemental Damage property, dealing damage of the chosen element.
...
\vspace*{\stretch{1}}
\begin{center}
    \adjincludegraphics[height=.5\textheight]{block-city-jagged}
\end{center}
\vspace*{\stretch{1}}