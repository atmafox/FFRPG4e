...
\begin{center}
  \adjincludegraphics[width=0.9\textwidth]{block-alchemist}
\end{center}
\end{ffcolpage}
...
\textbf{The Bad}: If the prot\'eg\'e is destroyed or killed, even if is possible to reconstruct, resurrect or any other way restore it, you lose Destiny Points.
...
Setting: Wars of Mana. Taken straight from Seiken Densetsu III (or Trials of Mana) storyline, Wars of Mana takes place on a high fantasy medieval world, where six great nations fight over control for the Mana, the magical energy that permeates the world.
...
\begin{center}
  \adjincludegraphics[width=0.9\textwidth]{block-bahamut-battle}
\end{center}
...
\textbf{Traits \& Quirks}: \ttrait{Nemesis (The Empire)}, \ttrait{People's Hero}, \ttrait{Prot\'eg\'e} (Narshe Mines); \tquirk{Moogle}, \tquirk{Feral}, and \tquirk{Fast}.\\
