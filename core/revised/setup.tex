...
\textbf{The Bad}: Many of the ancient things have profound and dire stories, carrying curses. You may suffer the curse that was upon something found, unless you spend Destiny Points.
...
As for Abilities, he notes down the first level Core Abilities: Nature's Path and Awakened (Geomancer) from
the Druid, and Block Projectiles from the Fencer. Due to his Stats, he also chooses a Specialty: Nature Warrior
(Polearms \& Bows), because what’s better than a Polearm-wielder Moogle? He hasn't leveled up enough to get other Specialties, so he goes to Equipment.
...
\noindent \textbf{Skills}: Perception 1 and Performance 1.\\
\textbf{Traits \& Quirks}: Nemesis (The Empire), People's Hero, Prot\'eg\'e (Narshe Mines); Moogle, Feral and Fast.\\
\textbf{HP} 52/52; \textbf{MP} 18/18; \textbf{ARM} 3; \textbf{MARM} 0\\
\textbf{Equipment}: Iron Spear (Air vs Earth, 6 damage), Leather Plate\\
\textbf{Abilities}: Nature's Path [Nature Warrior]; Awakened (Geomancer); Block Projectiles\\
\textbf{Actions}: !Geomancy, !Arrow Guard
\end{multimog}