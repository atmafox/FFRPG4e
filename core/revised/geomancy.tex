...
\textit{Environment Effect}: \textbf{Torrential Rain}: All combatants receive \tstatus{Fire Resist} and \tstatus{Lightning Vulnerable} statuses this battle. This has no effect on combatants that already have \tstatus{Vulnerable}, \tstatus{Resist}, \tstatus{Immune} or \tstatus{Absorb} Fire (for the \tstatus{Fire Resist}) or Lightning (for the \tstatus{Ice Resist}).
