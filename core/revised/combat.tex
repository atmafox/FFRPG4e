...
Ranged slow (4) action. No roll needed. You use an item or replace the equipped weapon with a weapon. In this case, the exchanged weapon is stored in your inventory as a free action. Should the target be unwilling, you must succeed in the Spell roll (for items that cast Spells) or a Water vs Air, difficulty 40 attack (for items that do not cast Spells).
