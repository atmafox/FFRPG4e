...
\begin{tabacc}[label=inv-acc1]
    \tabaccrow[name=Nishijin Belt,mlevel=1,cost=500,effect=\tstatus{Sleep} Immunity]
\end{tabacc}

\clearpage
\section{Inventory}
\label{sec:inv-inventory}
...
\clearpage
\subsection{Potions and Healing Items}
\label{subsec:potions}
...
\clearpage
\subsection{Battle Items}
\label{subsec:battleitems}

\begin{tabitem}[label=inv-battles]
    \tabitemrow[name=Arctic Wind,cost=100,effect=Cast the spell \tspell{Blizzard}]
\end{tabitem}
\vfill
\begin{center}
