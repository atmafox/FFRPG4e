...
\end{center}
\clearpage\weapontypesubsubsection%
...
\end{tabwpn}
{\footnotesize When cast by Super Ball's Critical Spell effect, \tspellblue{Black Hole}'s difficulty is 70.}
\clearpage\weapontypesubsubsection%
...
\regularsubsubsection\clearpage%
