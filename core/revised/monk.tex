...
\begin{tabjob}
    ...
    \tabjobsep%
    \multicolumn{2}{p{\textwidth}}{\tability{Zen Mind}: Core Ability acquired Base at level 60. Your attacks and reactions against enemies suffering any negative status effects may be rerolled once.} \\
    \tabjobspec{}
    \crystal{fire}{12pt} & %
...
% This table must go to its rightful position in line 38
