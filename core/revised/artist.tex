...
\begin{tabjob}
  ...
  \tabjobspec{}
    ...
    \tspec{Undue Criticism}: Requires Earth and Air level 7. You gain the \actype{magical=true} \taction{Hater}: Shame your target into a rage. Perform a Water vs Fire attack, difficulty 40 to inflict the \tstatus{Berserk} status until the end of the next round.\\
  \tabjobsep%
