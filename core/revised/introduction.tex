...
\begin{multicols}{2}
The game's core concept is ``nostalgia''. As such, the game must be flexible and customizable enough, so each group can emphasize the aspects they find most relevant to the gaming experience. Final Fantasy have over 25 years of history and different gamers had lots of different experiences.
...
\vfill
\begin{center}
\adjincludegraphics[width=0.95\textwidth]{block-trainwreck}
\end{center}