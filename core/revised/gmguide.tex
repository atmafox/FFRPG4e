...
\textit{Heat Wave}: All combatants receive \tstatus{Fire Weakness} and \tstatus{Ice Resist} statuses this battle. This has no effect on combatants that already have \tstatus{Weakness}, \tstatus{Resist}, \tstatus{Immune} or \tstatus{Absorb} Fire (for the \tstatus{Fire Weakness}) or Ice (for the \tstatus{Ice Resist}). 
