...
\textbf{Environment Effects}: Some effects can passively change the battle rules. Use these effects to change how the battlefield works and present new challenges and opportunities to your players. Here are some examples:

\textit{Heat Wave}: All combatants receive \tstatus{Fire Weakness} and \tstatus{Ice Resist} statuses this battle.
