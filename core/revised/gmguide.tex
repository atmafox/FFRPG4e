...
All antagonists should have at least a basic attack, which can be physical or magical. This attack is its \taction{Attack} action. Choose an Offensive Stat and Defensive Stat for the attack. The table below shows the adequate damage multiplier for each antagonist’s level.
