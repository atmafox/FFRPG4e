...
\begin{tabjob}
    ...
    \crystal{water}{12pt} & %
    \tspec{Iaijutsu}: Requires Water level 20. You gain the Slow (5) physical action \taction{Cleave}. You go through your opponents with a sharp blow. Make an Air vs Earth attack, difficulty 70, against all your enemies, to inflict the \tstatus{Death} status. All enemies left alive (either immune to \tstatus{Death} or due to a failed attack) suffer half weapon damage. \\
\end{tabjob}
