...
\begin{tabjob}
    ...
    \crystal{water}{12pt} & %
    \tspec{Marked Quarry}: Requires Water level 13. Once per round, when you hit a single target attack, reduce the difficulty of the next attack targeting the same character by 30. \\
    \crystal{earth}{12pt} \crystal{air}{12pt} & %
    ...
    \crystal{water}{12pt} & %
    \tspec{Toolbox}: Requires Water level 8. You gain one of the following Specialties: \tspec{Arm Aim}, \tspec{Leg Aim}, \tspec{Head Aim}, \tspec{Eye Aim} or \tspec{Aim Wing}, even if you haven’t met the requirements and even if you already chose a Specialty for \tspec{Nutcracker} and/or \tspec{Mindblow}. \\
    \crystal{earth}{12pt} & %
