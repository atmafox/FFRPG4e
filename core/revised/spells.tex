...
\begin{multicols}{2}
    ...
    \textit{Meteor}, acquired the 64 level, cost 155 MP\@. Roll Fire vs Water nine times, difficulty 0. For each success, deal 4 x Fire level \telem{Crush}-elemental magical damage to a random enemy. This spell ignores \tstatus{Reflect} and the target’s Magic Armor.
