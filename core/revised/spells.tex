...
\begin{multicols}{2}
    ...
    \textit{Dispel}, acquired at level 40, costs 60 MP\@. Roll Fire vs Water, difficulty 40. If successful, the target loses all the positive status effects. If it has Auto-Status or SOS-Status, these effects are disabled until the end of the round. This spell ignores \tstatus{Reflect}.
