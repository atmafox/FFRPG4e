...
\begin{multicols}{2}
    ...
    \textit{Quicken}, acquired at level 28, costs 40 MP\@. Choose you or an ally. Until the end of next round, all reduce the charge time of all Slow actions the target takes to zero.
