...
\begin{tabjob}
    ...
    \tabjobspec{}
    \crystal{air}{12pt} & %
    \tspec{Twincast}: Requires Air level 16. You gain the Slow (2) action \taction{W-Magic}. Using it, you cast two Spells (either learned and/or Arcane Focus) with one action. \taction{W-Magic} may not be used to cast spells whose base MP costs, added, exceed 150. \\
    \crystal{level}{12pt} \crystal{water}{12pt} & %
    \tspec{Forbidden Arcana}: Requires Water level 16 and character level 64. Choose an Arcane Mysteries Specialty of any Mage Job. You gain this Ability, even if you do not meet the requirements. \\
\end{tabjob}