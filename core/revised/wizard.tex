...
\begin{longtable}[c]{@{}rp{0.9\textwidth}@{}}
    ...
    \crystal{fire}{12pt} & %
    \tspec{Late Bloomer}: Requires Fire level 3. Choose any spell group granted by \tability{Arcane Adept}. You gain it, but earn the spells 9 levels later than usual. \\ \addlinespace[6pt]
    \midrule
    \\[-6pt]
    ...
    \crystal{fire}{12pt} & %
    \tspec{Encyclopedic Knowledge}: Requires Fire level 12. Choose and gain one Spell Group. Casting Spells from this Group is a Slow (2) action, unless when used as a reaction. May only be picked by a \textit{Sage}. \\ \addlinespace[6pt]\midrule
    \\[-6pt]
    ...
    \tspec{Force of Thought}: Requires Fire and Water level 14. Choose and gain a Spell group. \\ \addlinespace[6pt]\midrule
    \\[-6pt]
