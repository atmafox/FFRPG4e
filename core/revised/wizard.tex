...
\begin{tabjob}
    ...
    \tabjobspec{}
    \crystal{air}{12pt} & %
    \tspec{Twincast}: Requires Air level 16. You gain the Slow (2) action \taction{W-Magic}. Using it, you cast two Spells with one action. \taction{W-Magic} may not be used to cast spells whose base MP costs, added, exceed 150. \\
