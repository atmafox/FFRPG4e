...
\begin{ffcolpage}
    ...
    \end{mobstats} 
    This evil priest command Risen skeletons. He may summon them do his biddings, using nearby corpses. However, his powers can't raise undead armies... yet.
\end{ffcolpage}
...
\begin{ffcolpage}
    ...
    \end{mobstats} 
    An octopus and squid hybrid, the Kraken is a colossal beast that terrorizes the oceans, destroying ships with its powerful tentacles.
\end{ffcolpage}
