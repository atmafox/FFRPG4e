...
\begin{longtable}{lccp{0.45\textwidth}}
    \toprule \rowcolor{zebragray} \textbf{Status} & \textbf{Group} & \textbf{Type} & \textbf{Effect} \\ \midrule \endhead%
    \bottomrule \endfoot%9
    \tstatus{Absorb:} \textit{(Element)} & Positive & Elemental & Heal \textit{(elemental)} damage. \\
    \tstatus{Berserk} & Negative & Mental & You may only perform standard actions. You must always perform the \taction{Attack} action and can't delay. \\
    \tstatus{Blind} & Negative & Seal & Whenever you attack, roll twice and take the worst roll. \\
    \tstatus{Blink} & Positive & Illusion & Whenever you get attacked, the attacker rolls twice and take the worst roll. \\
    ...
    \tstatus{Confuse} & Negative & Mental & You may only perform standard actions. Ends immediately if you take damage.  Whenever you use a standard action, roll 1d10: \newline \rowcolors{1}{zebragray}{} \begin{tabular}{|cp{0.3\textwidth}|} \hline \rowcolor{zebragray} \textbf{Roll} & \textbf{Effect} \\ \hline 1 & Act normally \\ 2 or 10 & No action \\ 3 or 9 & Attack random ally \\ 4 or 8 & Attack random enemy \\ 5 or 6 & Heal, protect, or otherwise assist random enemy \\ 7 & Heal, protect, or otherwise assist random ally \\ \hline \end{tabular} \\
