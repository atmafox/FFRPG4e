...
\begin{tabjob}
    ...
    \tabjobspec{}
    \crystal{water}{12pt} & %
    \tspec{Immortal Soul}: Requires Water level 18. You gain the \tspell{Great Gospel} Spell. \\
    \crystal{air}{12pt} & %
    \tspec{Immortal Technique}: Requires Air level 18. Choose a reaction from any Job. You gain that reaction. \\
\end{tabjob}