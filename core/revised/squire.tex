...
\begin{tabjob}
    ...
    \tabjobsep%
    \ability{level=19, name=Accumulate, desc={You gain the Slow (4) Physical action \taction{Focus}. Using it, you accumulate strength for your next blows. You gain the \tstatus{Strengthen (Physical)} status until the end of the next round. You may add your Air level to your Armor and your Fire level to your Magic Armor. Specialties:}} \\ \nopagebreak
    \tabjobspec{}
    \crystal{water}{12pt} & %
