...
\begin{longtable}[c]{lp{0.75\textwidth}}
    \multicolumn{2}{c}{\textbf{Abilities}} \\ \midrule \endfirsthead
    \multicolumn{2}{p{0.9\textwidth}}{\tability{Basic Skill}: Core Ability acquired at level 1. Choose another Secondary Job. You earn that job’s first level Core Ability. Regardless of the chosen Job, the Specialties for \textit{Basic Skill} are:} \\ \nopagebreak
    ...
    \\
    \multicolumn{2}{p{0.9\textwidth}}{\tability{Acumulate}: You gain the Slow (4) Physical action \taction{Focus}. Using it, you accumulate strength for your next blows. You gain the \tstatus{Strengthen (Physical)} status until the end of the next round. You may add your Air level to your Armor and your Fire level to your Magic Armor. Specialties:} \\ \nopagebreak
    \multicolumn{2}{l}{\textbf{Specialties:}} \\ \nopagebreak
    \crystal{water}{12pt} & %
    ...
    \\
    \multicolumn{2}{p{0.9\textwidth}}{\tability{Overwhelm Defenses}: Core Ability acquired at level 35. Once per phase, when you miss a non-spell attack roll or reaction, you may increase the difficulty by 20, to a maximum of 99, to re-roll it.} \\ \nopagebreak
    \multicolumn{2}{l}{\textbf{Specialties:}} \\ \nopagebreak
    \crystal{fire}{12pt} & %
    ...
    \\
    \multicolumn{2}{p{0.9\textwidth}}{\tability{Tailwind}: Core Ability acquired at level 50. You gain the Ranged Quick action \taction{Yell}. Use it on an ally. The target gains one extra initiative dice with value equal to the current phase.} \\ \nopagebreak
    \multicolumn{2}{l}{\textbf{Specialties:}} \\
