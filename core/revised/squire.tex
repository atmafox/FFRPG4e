...
\begin{tabjob}
    ...
    \tspec{Throw Stone}: Requires Earth and Air level 2. You gain the Ranged Quick physical action \taction{Throw Stone}. You gather a rock and throw at your opponent, making an Air vs Air, difficulty 40 attack. If you hit, you deal \telem{Crush} elemental damage equal to highest base damage amongst throwing weapons of your level or lower. \\
    \crystal{level}{12pt} & %
    ...
    \tspec{Ordered Retreat}: Requires Air and Water level 16. When you succeed with the \taction{Flee} action, all allies successfully run from combat.\\
