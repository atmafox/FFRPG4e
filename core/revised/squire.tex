...
\begin{jobchoice}
\crystal{fire}{12pt} & %
\tspec{Awareness}: Requires Fire level 16. You gain the Ranged magical action \taction{Awareness}. Do a Fire vs Air, diff 0, attack against all enemies. Your acute senses detect traces of enemy presence. All enemies hit lose the \tstatus{Blink} and \tstatus{Vanish} status effect.  \\
