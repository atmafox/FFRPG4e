...
\begin{ffcolpage}
    \begin{mobstats}[name=Burning Llama, level=52, type=beast, rarity=boss, init=5,
...
\begin{mobstats}[name=MONSTER NAME, level=35, type=abberation, rarity=common, init=3,
