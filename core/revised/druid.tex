...
\begin{tabjob}
    ...
    \multicolumn{2}{c}{
        ...
        \begin{tabular}{p{0.8\textwidth}}
            \toprule
            You deal 10x Air level Air-elemental damage or grant the Float status to your group until the end of the round. \\
            At 30th level or greater, you may spend 30 MP when using this action to either enhance the damage option to 15x. \\
            Cast \tstatus{Float} on the party and force the target to lose their highest initiative die.  This is a \tstatus{Seal}-type status effect.  Until the end of the round, the target cannot be affected by this again. \\ \bottomrule
        \end{tabular}
    } \\
