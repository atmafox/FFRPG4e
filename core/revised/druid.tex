...
\begin{tabjob}
    ...
    \crystal{air}{12pt} & %
    \tspec{Air Gust}: Requires Air level 7. You gain the Ranged Slow (2) magical action \taction{Air Wave}. Using it, you perform an (Air or Fire) vs Water attack against a target, difficulty 40. If successful, choose one: You deal 10x Air level Air-elemental damage or grant the Float status to your group until the end of the round.\pc
    At 30th level or greater, you may spend 30 MP when using this action to either enhance the damage option to 15x, or while doing 10x damage or floating the party, force the target to lose their highest initiative die. Treat this as a \tstatus{Seal}-type status effect, until the end of the round the target cannot be affected again. \\
