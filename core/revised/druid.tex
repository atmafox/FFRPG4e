...
\crystal{level}{12pt} & %
\textit{Geomancer}: You may spend MP to increase the power of their \taction{Geomancy} action, as indicated under each terrain section below, starting at page~\pageref{sec:magic-geo}. \\
\crystal{level}{12pt} & %
