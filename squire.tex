...
\noindent\tability{Basic Skill}: Core Ability acquired at level 1. Choose another Secondary Job. You earn that job’s first level Core Ability. Regardless of the chosen Job, the Specialties for \textit{Basic Skill} are: \pc

\begin{jobspec}
\crystal{earth}{12pt} \crystal{air}{12pt} & %
\tspec{Throw Stone}: Requires Earth and Air level 2. You gain the Ranged Quick physical action \taction{Throw Stone}. You gather a rock and throw at your opponent, making an Air vs Air, difficulty 40 attack. If you hit, you deal Crush-elemental damage equal to the level-appropriate Throwing Weapon’s damage. \\
\crystal{level}{12pt} & %
...
\begin{ffminipage}
\noindent\tability{Acumulate}: You gain the Slow(4) Physical action \taction{Focus}. Using it, you accumulate strength for your next blows. You gain the \tstatus{Strengthen (Physical)} status until the end of the next round. You may add your Air level to your Armor and your Fire level to your Magic Armor. Specialties: \pc
...
\begin{ffminipage}
\noindent\tability{Overwhelm Defenses}: Core Ability acquired at level 35. Once per phase, when you miss a non-spell attack roll or reaction, you may increase the difficulty by 20, to a maximum of 99, to re-roll it. \pc
...
\begin{ffminipage}
\noindent\tability{Tailwind}: Core Ability acquired at level 50. You gain the Ranged Quick action \taction{Yell}. Use it on an ally. The target gains one extra initiative dice with value equal to the current phase. 

\begin{jobspec}
\crystal{air}{12pt} \crystal{water} & %
\tspec{Ordered Retreat}:Requires Air and Water level 16. When you succeed with the !Escape action, treat as if all allies succeeded with a !Escape action this phase. \\
